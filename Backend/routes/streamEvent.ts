...
//                              message === "6"  ? "6": 
//                              "";
//           const filePath = path.join(__dirname, "public", "assets", fileType, `${fileType}${fileNumber}.mp4`);
...
//               socket.emit(`${fileType}_metadata`, { name: `${fileType}.mp4`, size: formatFileSize(stats.size), type: `${fileType}/mp4` });
